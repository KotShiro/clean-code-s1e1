...
var incompleteTaskHolder=document.querySelector(".current-tasks");//ul of #incompleteTasks
...
var createNewTaskElement=function(taskString){
    ...
    deleteButton.className="task__btn_del";
    deleteButtonImg.src='./remove.svg';
    deleteButtonImg.alt='remove-icon'
    deleteButtonImg.classList.add('task__img-del');
...
//select ListItems children
    ...
    var deleteButton=taskListItem.querySelector("button.task__btn_del");
